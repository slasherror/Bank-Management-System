        ...
        <div class="profile-desc">
          <div class="profile-pic">
            <div class="count-indicator">
              <a href="{{url('employeeprofile')}}"><img class="img-xs rounded-circle " src="{{asset('/')}}employeeimages/{{$employeedata->image}}" alt=""></a>
              <span class="count bg-success"></span>
            </div>
            <div class="profile-name">
              {{-- <h3 style="background:white; size:10px"><a href="{{url('employeeprofile')}}" style="background:white; size:10px">{{$employeedata->name}}</a></h3> --}}
              <span><a href="{{url('employeeprofile')}}" >{{$employeedata->name}}</a></span>
            </div>
          </div>
